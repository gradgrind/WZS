...
#T = Tr("timetable.w365.read_w365")

### +++++

from timetable.w365.w365base import W365_DB, read_active_scenario
from timetable.w365.rooms import read_rooms
from timetable.w365.subjects import read_subjects
from timetable.w365.teachers import read_teachers
from timetable.w365.class_groups import read_groups
from timetable.w365.activities import read_activities
from timetable.w365.timeslots import read_days, read_periods
